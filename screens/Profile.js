...
const Profile = ({ navigation }) => {
    ...
    return (
        <SafeAreaView>
            <ScrollView>
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <View style={{ flex: 1, paddingTop: 5 }}>
                        ...
                        <Text style={{ padding: 5, marginTop: 5, marginBottom: 5, backgroundColor: '#fff', color: '#007bff', fontWeight: 'bold', marginHorizontal: 10, textAlign: 'center', alignSelf: 'center' }}>Keem</Text>
                    </View>
                    <View style={{ flex: 1 }}>
                ...
                <View style={{ width: Dimensions.get("window").width, marginTop: 5, }}>
                    {/**Playlist */}
                    {/* <Text style={{ padding: 5, marginTop: 5, marginBottom: 5, backgroundColor: '#fff', color: '#007bff', fontWeight: 'bold', marginHorizontal: 10, textAlign: 'center', alignSelf: 'center' }}>Public Playlists</Text> */}
                    <Carousel
            ...
            /> */}
                <View style={{ borderTopWidth: 2, borderColor: '#007bff' }}>
                    {userPostsMarkup}
                </View>
            </ScrollView>
        </SafeAreaView >
